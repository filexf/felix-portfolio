...
export default function Navbar() {
  ...
  return (
    <>
      <nav className="sticky top-[0] z-100 flex w-full flex-col items-center justify-end gap-[10px] py-1.5 shadow-md"
          ...
          <div className="flex flex-row justify-between gap-[20px] p-[10px]">
            <div className="flex flex-row items-center gap-[25px]">
              <div className="flex size-[2.4rem] transform items-center transition hover:scale-102">
                <Link to="/">
                  <img src={logoSite} alt="Logo website" className={darkMode ? "filter invert" : ""} />
                </Link>
              </div>
